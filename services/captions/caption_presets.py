...
PRESETS: dict[str, CaptionPreset] = {
    ...
    "readable": CaptionPreset(
        name="readable",
        display_name="Readable",
        description="Balanced default with strong contrast and comfortable line length.",
        ...
        position="bottom",
        max_words_per_line=4,
        animation={"type": "fade", "duration": 0.16, "delay_between_words": 0.04},
        word_highlight=False,
        highlight_color=_WHITE,
        background_box=False,
        background_padding=0,
    ...
    "accessible_box": CaptionPreset(
        name="accessible_box",
        display_name="Accessible Box",
        description="Dark slab background with generous spacing for maximum legibility.",
        font_name="Inter-Bold",
        font_size=50,
        primary_color=_WHITE,
        secondary_color=_WHITE,
    ...
    "speaker_focus": CaptionPreset(
        name="speaker_focus",
        display_name="Speaker Focus",
        description="Readable word highlight with a warm gold accent on the active word.",
        font_name="Inter-Bold",
        font_size=56,
        primary_color=_WHITE,
        secondary_color="&H0000D7FF",
        ...
        position="bottom",
        max_words_per_line=4,
        animation={"type": "fade", "duration": 0.12, "delay_between_words": 0.0},
        word_highlight=True,
        highlight_color="&H0000D7FF",
        background_box=False,
        background_padding=0,
    ...
    "focus_box": CaptionPreset(
        name="focus_box",
        display_name="Focus Box",
        description="Boxed active word with high-contrast colors tuned for accessibility.",
        font_name="Inter-Bold",
        font_size=56,
        primary_color=_WHITE,
        secondary_color="&H0000D7FF",
    ...
    "calm_karaoke": CaptionPreset(
        name="calm_karaoke",
        display_name="Calm Karaoke",
        description="Karaoke fill tuned for readability instead of hype.",
        font_name="Montserrat-Bold",
        font_size=56,
        primary_color=_WHITE,
        secondary_color="&H0000D7FF",
        ...
        position="bottom",
        max_words_per_line=4,
        animation={"type": "none", "duration": 0.0, "delay_between_words": 0.06},
        word_highlight=True,
        highlight_color="&H0000D7FF",
        background_box=False,
        background_padding=0,
    ...
    "karaoke_gold": CaptionPreset(
        ...
        position="bottom",
        max_words_per_line=4,
        animation={"type": "none", "duration": 0.0, "delay_between_words": 0.08},
        word_highlight=True,
        highlight_color="&H0000D7FF",
        background_box=False,
        background_padding=0,
...
LEGACY_ALIASES: dict[str, str] = {
    ...
    "uppercase": "contrast",
    "lowercase": "clean",
    "accessible": "accessible_box",
    "readable_captions": "readable",
    "karaoke_readable": "calm_karaoke",
}
